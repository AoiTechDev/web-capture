    ...
    <section id="cta-section" className="py-20 relative">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <h2 className="text-4xl sm:text-5xl font-semibold mb-6">
          Ready to <span className="gradient-text">Organize</span> Your
          Internet?
        </h2>
        ...
        <button className="bg-[var(--blue-500)] px-12 py-6 rounded-2xl font-semibold text-xl neon-glow hover-scale mb-6">
          <svg
        ...
        <div className="flex items-center justify-center space-x-2 text-yellow-400">
          ...
          <span className="text-[var(--text-muted)] ml-2">4.9/5 from 12,000+ users</span>
        </div>
      </div>
    </section>
  );
