  ...
  return (
    <section id="cta-section" className="py-20 relative">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <button className="bg-gradient-to-r from-cyan-500 to-purple-600 px-12 py-6 rounded-2xl font-bold text-xl neon-glow hover-scale mb-6">
          <svg
        ...
        <div className="flex items-center justify-center space-x-2 text-yellow-400">
          ...
          <span className="text-gray-300 ml-2">4.9/5 from 12,000+ users</span>
        </div>
      </div>
    </section>
  );
